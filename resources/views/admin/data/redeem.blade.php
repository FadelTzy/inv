                ...
                <div class="modal-body">
                    <form id="datatipe" method="POST">
                        ...
                        <div class="form-group">
                            <label for="Nama">Nama Redeem</label>
                            <div class="input-group">

                                <input type="text" name="judul" required placeholder="Input Nama" class="form-control">
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-6">
                                    <div class="form-group">
                                        <label for="Nama">Jumlah Hadiah (Rupiah)</label>
                                        <div class="input-group">

                                            <input type="text" onkeyup="setmodal(this)" id="jumlahinvestasi"
                                                name="investasi" required placeholder="Input Investasi "
                                                class="form-control">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-6">
                                    <div class="form-group">
                                        <label for="Nama">Jumlah Penerima</label>

                                        <div class="input-group">
                                            <input type="number" name="penerima" required class="form-control ">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <button type="button" onclick="generate()" class="btn btn-primary btn-sm">Generate</button>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-6">
                                    <div class="form-group">
                                        <label for="Nama">Status Penerima</label>
                                        <div class="input-group">
                                            <select class="form-control" name="sp" id="">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="judul" id="judulu" required placeholder="Input Nama" class="form-control">
                                </div>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" onkeyup="setmodal(this)" id="jumlahinvestasiu"
                                                    name="investasi" required placeholder="Input Investasi "
                                                    class="form-control">
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="date" name="awal" id="awalu" required class="form-control ">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="date" name="akhir" id="akhiru" required class="form-control ">
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="number" name="penerima" id="penerimau" required class="form-control ">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-8 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text"  name="kode" id="kodeu" required
                                                    class="form-control ">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-4 col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <button type="button" onclick="generateu()" class="btn btn-primary btn-sm">Generate</button>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-group">
                                            <label for="Nama">Status Penerima</label>
                                            <div class="input-group">
                                                <select class="form-control" name="sp" id="jenisu">
                                                    <option selected value="1">Public</option>
                                                    <option value="2">Private</option>
                                                </select>
                                            </div>
...
@push('js')
    ...
    <script>
        ...
        function generate() {
            var make = makeid(6);
            $("#kode").val(make.toUpperCase())
            console.log(make);
        }
        function generateu() {
            var make = makeid(6);
            $("#kodeu").val(make.toUpperCase())
            console.log(make);
        }
        ...
        function staffdel(id) {
            ...
            if (data) {
                ...
                $.ajax({
                    url: url + '/data-master/redeem-code/' + id,
                    type: "delete",
                    success: function(e) {
                        $.LoadingOverlay("hide");
                        if (e == 'success') {
        ...
        function staffupd(id) {
            $('#up').modal('show');
            $("#jumlahinvestasiu").val(id.nominal);
            $("#jenisu").val(id.jenis);
            $("#awalu").val(id.start);
            $("#akhiru").val(id.expayer);
            $("#penerimau").val(id.peserta)
            $("#judulu").val(id.judul);
            $("#kodeu").val(id.kode);
